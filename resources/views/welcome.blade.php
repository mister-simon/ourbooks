<x-guest-layout>
    ...
    <div class="flex grow flex-col items-center bg-gray-100 pt-6 sm:justify-center sm:pt-0">
        <div class="prose mt-6 overflow-hidden bg-white px-6 py-4 shadow-md sm:rounded-lg">
