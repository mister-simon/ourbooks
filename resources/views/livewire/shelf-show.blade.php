    ...
    <x-page-card-wide
        ...
        <div
            ...
            <div
                ...
                x-text="`{{ __('${onlySelected.length} currently selected') }} ▼`">
            </div>

            <div
                class="dropdown-content z-20"
                tabindex="0">
                <div class="join join-vertical w-auto bg-base-100 md:join-horizontal" x-cloak>
                    <div
                        ...
                        <button
                            ...
                            @click.prevent="onlySelected.length && $wire.rateMany(onlySelected, shelfId, rating)">{{ __('Save rating') }}</button>
                    </div>
                    ...
                    <div
                        ...
                        <button
                            ...
                            class="btn btn-sm"
                            x-bind:disabled="onlySelected.length === 0"
                            @click.prevent="onlySelected.length && $wire.readMany(onlySelected, shelfId, read)">{{ __('Save read status') }}</button>
                    </div>
                </div>
            </div>
        </div>

        <x-input-error for="books" />
