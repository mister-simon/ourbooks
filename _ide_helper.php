...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function attributeMarkdown($string, $options = [])
        {
                        return \Illuminate\Support\Str::attributeMarkdown($string, $options);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function attributeMarkdown($options = [])
        {
                        return \Illuminate\Support\Stringable::attributeMarkdown($options);
        }
